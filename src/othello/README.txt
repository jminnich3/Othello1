The essential files to look at for your project are:
AIPlayer.java
Board.java
...
RunTestCases compares your minimax with correct values for specific boards, depth, and evaluation function.
